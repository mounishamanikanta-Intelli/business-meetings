...
import ScientificProgramTableView from './components/ScientificProgramTableView'
...
export default (S) =>
  S.list()
    ...
    .items([
      ...
      S.listItem()
        ...
        .child(
          S.list()
            ...
            // Unified Scientific program System
      S.listItem()
        .title('Scientific Program System')
        .id('scientificProgramSystem')
        .icon(DocumentIcon)
        .child(
          S.list()
            .title('Scientific Program Management System')
            .items([
              // Brochure Settings
              S.listItem()
                .title('Scientific Program Settings')
                .id('scientificProgramSettings')
                .icon(DocumentIcon)
                .child(
                  S.document()
                    .schemaType('scientificProgramSettings')
                    .documentId('scientificProgramSettings')
                    .title('Scientific Program Settings')
                ),
              // Brochure Downloads - Table View
              S.listItem()
                .title('Downloads Table')
                .id('scientificProgramDownloadsTable')
                .icon(DownloadIcon)
                .child(
                  S.component(ScientificProgramTableView)
                    .title('Scientific Program Download Submissions - Table View')
                ),
              // Brochure Downloads - List View
              S.listItem()
                .title('Downloads List')
                .id('scientificProgramDownloadsList')
                .icon(DownloadIcon)
                .child(
                  S.documentTypeList('scientificProgramDownload')
                    .title('Scientific Program Download Submissions - List View')
                    .defaultOrdering([{field: 'downloadTimestamp', direction: 'desc'}])
                )
            ])
        ),
      ...
      S.listItem().title('Conference Awards').schemaType('conferenceAwards').child(S.documentTypeList('conferenceAwards')),
