...
import conferenceAwards from "./conferenceAwards";
...
import scientificProgramDownload from './scientificProgramDownload';
import scientificProgramSettings from './scientificProgramSettings';
...
export const schemaTypes = [
  ...
  brochureSettings,
  brochureDownload,
  scientificProgramDownload,
  scientificProgramSettings,
  mapLocation,
  // Registration system schemas
