...
export const scientificProgramDownload = defineType({
  name: 'scientificProgramDownload',
  title: 'Scientific Program Download',
  type: 'document',
  icon: DownloadIcon,
...
export default scientificProgramDownload;
