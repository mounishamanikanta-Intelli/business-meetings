...
export const scientificProgramSettings = defineType({
  name: 'scientificProgramSettings',
  ...
  fields: [
    ...
    defineField({
      ...
      initialValue: 'Download our comprehensive Scientific Program brochure to learn more about the event.',
    }),
...
export default scientificProgramSettings;
