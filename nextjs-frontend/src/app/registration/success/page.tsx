              ...
              <div className="space-y-6">
                  ...
                  <div className="border rounded-lg p-4 bg-green-50 border-green-200">
                    ...
                    <div className="mt-3 p-3 bg-blue-100 rounded border border-blue-300">
                      <p className="text-xs text-blue-700 font-medium">
                        Payment processed securely through {paymentMethod}
                      </p>
                    </div>
                  </div>
                )}
                ...
                {registrationDetails && (
                  <div className="border border-gray-200 rounded-lg p-6">
                    <h3 className="text-xl font-large text-gray-900 mb-4">REGISTRATION DETAILS</h3>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div className="space-y-2">
                          ...
                          <p><strong>Number of Accompanying persons:</strong> {registrationDetails.numberOfAccompanyingPersons}</p>
                        </div>
                        <div className="space-y-2">
                          ...
                          {registrationDetails.checkInDate && (
                            <p><strong>Check-In Date:</strong> {registrationDetails.checkInDate}</p>
                          )}
                          {registrationDetails.checkOutDate && (
                            <p><strong>Check-Out Date:</strong> {registrationDetails.checkOutDate}</p>
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="text-sm space-y-1">
                        ...
                        {registrationDetails.pricing?.accompanyingPersonsCost > 0 && (
                          <div className="flex justify-between">
                            <span>Accompanying Persons Cost:</span>
                            <span>{currency} {registrationDetails.pricing.accompanyingPersonsCost}</span>
                          </div>
                        )}
