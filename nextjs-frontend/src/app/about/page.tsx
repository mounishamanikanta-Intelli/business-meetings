...
export default async function AboutPage() {
  ...
  const conferenceData = await getHeroSection();
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            <h1 className="uppercase text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            <h1 className="text-2xl md:text-5xl lg:text-6xl font-bold mb-2 md:mb-4 text-white">
              About
            </h1>
            {brandTagline && (
          ...
          <div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
                ...
                <div className="prose prose-lg max-w-none text-gray-700 leading-7 tracking-normal text-justify">
                  {about?.description ? (
