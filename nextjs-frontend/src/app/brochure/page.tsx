...
function BrochureHeroClient({ imageUrl, overlayPercent , conferenceData }: { imageUrl?: string; overlayPercent?: number; conferenceData: any }) {
...
export default async function BrochurePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <BrochureHeroClient imageUrl={heroImageUrl} overlayPercent={overlayPercent} conferenceData={conferenceDataAll}/>
