...
import { 
  ...
  hasFormErrors,
  ScientificProgramFormData
} from '../types/brochure';

export default function ScientificProgramForm() {
  const [formData, setFormData] = useState<ScientificProgramFormData>({
    fullName: '',
    email: '',
    phone: '',
    organization: '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/scientific-program/submit', {
        method: 'POST',
        headers: {
